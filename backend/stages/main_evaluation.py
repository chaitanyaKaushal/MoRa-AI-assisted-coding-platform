...
5. **DATA STRUCTURE FORMATTING**:
  - ListNode as List[int]: [1,2,3].
  - TreeNode as List[int|None] in level order: [1,2,None,4].
...
21. Return ONLY the two functions - NO other code"""
...
def improve_problem(problem_id: str, request: ImprovementRequest, db: Session = Depends(get_db)):
    ...
    def event_stream():
        try:
            ...
            reference_code = stage5_consensus_reference(spec, test_inputs_dict, user_guidance=user_ground_truth)
